...
const Navmesh = () => {
  ...
  const [targetp, _setTarget] = React.useState<THREE.Vector3>(new THREE.Vector3(0, 0, 0))
  const [hasTarget, _setHasTarget] = React.useState(false)
  ...
  React.useMemo(() => {
    setDebugPoints(debugPoints as any)
    if (navMesh) {
